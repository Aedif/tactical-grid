...
export function registerSettings() {
  ...
  <fieldset>
    ...
    <div class="form-group slim">
      ...
      <p class="hint">${game.i18n.localize(`${MODULE_ID}.settings.defaultViewDistance.hint`)}</p>
    </div>
    <div class="form-group">
      ...
      <div class="form-group">
        <label>Color</label>
        <div class="form-fields">
            <color-picker name="flags.${MODULE_ID}.color" value="${shapeColor}"></color-picker>
        </div>
      </div>
  </fieldset>
    `);

        $(tokenConfig.element).find('[name="sight.color"]').closest('fieldset').after(control);
...
<fieldset>
  ...
  <div class="form-group">
    ...
    <p class="hint"><b>(REQUIRES CANVAS RELOAD)</b></p>
  </div>
</fieldset>
    `);
